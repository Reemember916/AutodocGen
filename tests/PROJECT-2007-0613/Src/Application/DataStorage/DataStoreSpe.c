...
Uint16 SpeDataRead(Uint16 v_index_u16)
{
    ...
    memset(l_rBuff_u16, 0, sizeof(l_rBuff_u16));
        ...
        /* 获取特定数据 */
        (void)STORE_DATAREAD_DRI(l_addr_u32,l_rBuff_u16,(SPE_DATA_STUCT_NUM - 1U) );
...
Uint16 SpeDataCrcRead(Uint16 v_index_u16)
{
    ...
    if( v_index_u16 < SPE_DATA_DINDEX_MAX)
    {
        ...
        /* 获取特定数据 */
        (void)STORE_DATAREAD_DRI(l_addr_u32,&l_crcData_u16,1U);
...
Uint16 SpeDataWrite(Uint16 v_index_u16,Uint16 v_wData_u16)
{
    ...
    if( v_index_u16 < SPE_DATA_DINDEX_MAX )
    {
        ...
        /* 擦除扇区 */
        STORE_SECTORERASE_DRI(l_addr_u32);
        ...
        while(l_delayCnt_1_u16 < SPE_DATA_WRITE_OVER_TIME_MS)
        {
            ...
            /* 获取FLASH忙状态 */
            l_busyState_u16 = STORE_FLASHISBUSY_DRI();
        ...
        if(l_delayCnt_1_u16 < SPE_DATA_WRITE_OVER_TIME_MS)
        {
            ...
            /* 将数据写入FLASH中 */
            STORE_DATAWRITE_DRI(l_addr_u32,l_wBuff_1_u16,SPE_DATA_STUCT_NUM);
            ...
            {
                /* 回读内存中数据 */
                (void)STORE_DATAREAD_DRI(l_addr_u32,l_rBuff_u16,SPE_DATA_STUCT_NUM);
