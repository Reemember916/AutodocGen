...
static Uint16 StartUpFlagHotWriteVerify(void)
{
    ...
    {
        HardXintUint16Write(CPLD_ADDR_W_STARTUP_FLAG, CPLD_STARTUP_FLAG_HOT);
        delayUs(STARTUP_FLAG_VERIFY_RETRY_DELAY_US);
        l_readFlag_u16 = HardXintUint16Read(CPLD_ADDR_R_STARTUP_FLAG);
...
void StartUpModeJudge(void)
{
    ...
    l_startupFlag_u16 = HardXintUint16Read(CPLD_ADDR_R_STARTUP_FLAG);
