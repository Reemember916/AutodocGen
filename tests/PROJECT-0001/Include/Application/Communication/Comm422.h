...
#define GROUND_MAINT_FUNC_PID_PARA_ADJUST (0x04U)      /* 地面维护功能控制参数修改 */
/* 地面维护功能执行结果 */
...
#define COMM_MAINT_TX_PACK_FRAME_ID_5 (5U)    /* 维护通信发送报文包号5：软件版本与CRC */
...
extern void   GroundMaintProcessSoftwCRC(void);
extern void   GroundMaintProcessDataDownLoad(void);
extern void   GroundMaintProcessDataErase(void);
extern void   CommMaintExecStatusUpdate(Uint16 v_func_u16, Uint16 v_result_u16);
extern Uint16 s_softwCRC_u16;          /* 应用软件CRC校验码 */
extern Uint16 s_softwCRC_Update_u16;   /* 加载软件CRC校验码 */
#endif /* COMM422_H_ */
